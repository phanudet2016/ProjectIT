        ...
        <div class="row">
          ...
          <div class="card">
            <div class="card-block">
              <h4 class="card-title">แจ้งความต้องการใช้อุปกรณ์</h4>
              <p class="card-text" style="color:#9A9A9A;">(แจ้งความต้องการใช้อุปกรณ์ทางการแพทย์ในกรณ์ที่ไม่เพียงพอต่อการยืม)</p>
            </div>
          </div>
          </div>
        </div>
