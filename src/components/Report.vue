<template>
  <div>
    ...
    <div class="nav-header">
      <ul>
        <li class="topic">
          <p style="font-size:25px;border-bottom: 2px solid #ffffff"><b>รายงานการยืม</b></p>
        </li>
        ...
        <div class="row">
          ...
          <div class="card">
            <div class="card-block">
              <h4 class="card-title">
                รายงานข้อมูลการยืมอุปกรณ์ทางการแพทย์ ของแต่ละอุปกรณ์
             ...
             <!-- <p class="card-text">รวม : {{realtimeplus}} รายการ</p> !-->
              ...
              <table class="table">
                ...
                <tbody>
                  <tr v-for="history of searchEqm" v-if="history.status === 'ถูกยืม'">
                    <td>{{history.idLend}}</td>
                    <td>{{history.nameEqm}}</td>
                    <td>{{history.numberShow}}</td>
                    <td>{{history.firstname}} {{history.lastname}}</td>
                    <td>{{history.department}}</td>
                    <td>{{history.date}}</td>
                    <td>{{history.timeLength}}</td>
                    <td>{{history.amountDate}} วัน</td>
    ...
    <div class="print" v-if="print === 'print'">
      ...
      <h1><b>รายงานข้อมูลสถิติการยืมอุปกรณ์</b></h1><br>
      ...
      <center>
      <h3 style="text-align:left;">รายงานข้อมูลการยืมอุปกรณ์</h3>
      <table border="1" style="margin-top: 10px;">
        <tr>
          <th style="width:80px;text-align: center;height:50px;">รหัสการยืม</th>
          <th style="width:250px;text-align: center;">ชื่ออุปกรณ์</th>
          <th style="text-align: center;">จำนวน</th>
          <th style="text-align: center;">ชื่อ - สกุล ผู้ยืม</th>
          <th style="text-align: center;">แผนก ที่ยืม</th>
          <th style="text-align: center;">วันที่ยืม</th>
          <th style="text-align: center;">วันที่คืน</th>
          <th style="text-align: center;">ระยะเวลารวม</th>
        </tr>
        <tr v-for="history of searchEqm" v-if="history.status === 'ถูกยืม'">
          <td style="text-align: center;">{{history.idLend}}</td>
          <td style="padding-left:10px;">{{history.nameEqm}}</td>
          ...
          <td style="text-align: center;">{{history.amountDate}} วัน</td>
        </tr>
      </table>
      </center>
    </div>
